...
## [0.2.0](https://github.com/ctlai95/language-server-runtimes/compare/chat-client-ui-types/v0.1.37...chat-client-ui-types/v0.2.0) (2025-05-22)
...
* The following workspace dependencies were updated
  * dependencies
    * @aws/language-server-runtimes-types bumped from ^0.1.31 to ^0.2.0
