...
## [0.2.0](https://github.com/ctlai95/language-server-runtimes/compare/chat-client-ui-types/v0.1.34...chat-client-ui-types/v0.2.0) (2025-05-14)
...
* The following workspace dependencies were updated
  * dependencies
    * @aws/language-server-runtimes-types bumped from ^0.1.28 to ^0.2.0
