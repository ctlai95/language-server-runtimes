...
## [0.2.0](https://github.com/ctlai95/language-server-runtimes/compare/chat-client-ui-types/v0.1.46...chat-client-ui-types/v0.2.0) (2025-06-19)
...
* The following workspace dependencies were updated
  * dependencies
    * @aws/language-server-runtimes-types bumped from ^0.1.40 to ^0.2.0
