...
## [0.2.0](https://github.com/ctlai95/language-server-runtimes/compare/chat-client-ui-types/v0.1.58...chat-client-ui-types/v0.2.0) (2025-08-01)
...
* The following workspace dependencies were updated
  * dependencies
    * @aws/language-server-runtimes-types bumped from ^0.1.52 to ^0.2.0
